...
<div class="row g-3 align-items-center mb-4">
        ...
        <div class="col-auto">
            <input type="text" name="name" id="inputNom" class="form-control" aria-describedby="nomHelpInline">
        </div>
        <div class="col-auto">
    ...
    <div class="row g-3 align-items-center mb-4">
        ...
        <div class="col-auto">
            <input type="tel" name="phone" id="inputPhone" class="form-control" aria-describedby="phoneHelpInline">
        </div>
        <div class="col-auto">
    ...
    <div class="row g-3 align-items-center mb-4">
        ...
        <div class="col-auto">
            <input type="date" name="date_of_birth" id="inputDob" class="form-control" aria-describedby="dobHelpInline">
        </div>
        <div class="col-auto">
    ...
    <div class="row g-3 align-items-center mb-4">
        ...
        <div class="col-auto">
            <input type="text" name="address" id="inputAddress" class="form-control" aria-describedby="addressHelpInline">
        </div>
        <div class="col-auto">
